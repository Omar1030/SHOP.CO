    ...
    <section id="new-arrivals">
      <div className="container mx-auto px-4 py-[70px] border-b-1 border-gray-300">
        ...
        <div id="products" className="grid grid-cols-[auto_auto] md:grid-cols-4 lg:grid-cols-4 gap-3">
          {newProducts.map((product, index) => (loading ? <SkeletonCard key={index} /> : <ProductCard key={product.id} src={product.thumbnail} title={product.title} price={product.price} id={product.id} />))}
        </div>
        <Link to="/shop">
